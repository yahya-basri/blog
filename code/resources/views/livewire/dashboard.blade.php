<div>
	...
	<a href="#">
		<h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Total posts</h5>
	</a>
	<p class="mb-3 font-normal text-2xl text-gray-700 dark:text-gray-400"> {{$totalPosts}} </p>
